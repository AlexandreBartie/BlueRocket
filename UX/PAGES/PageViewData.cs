...
namespace BlueRocket.PAGES.TestData
{
    internal class PageViewData : PageBuilder
    {
        internal PageViewData(UserControl prmPage, Control prmDataGrid) : base(prmPage, prmDataGrid) { }
    }
