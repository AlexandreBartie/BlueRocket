...
namespace BlueRocket.PAGES.TestCode
{
    internal class PageViewCode : PageBuilder
    {
        internal PageViewCode(UserControl prmPage, Control prmDataGrid) : base(prmPage, prmDataGrid) { }
    }
    internal class PageBuilder : PageControl
    {
        ...
        internal PageBuilder(UserControl prmPage, Control prmDataGrid)
        {
            ...
            Resources.SetPage(prmPage, prmDataGrid);
        }
    ...
    internal class PageResources
    {
        ...
        internal void SetPage(UserControl prmPage, Control prmDataGrid)
        {
            Page = (usrViewData)prmPage;

            DataGrid = (DataGridView)prmDataGrid;
    ...
    internal class PageActions : PageBase
    {
        ...
        {
            //ListViewHitTestInfo info = Resources.DataGrid.HitTest(prmMouseX, prmMouseY);
    ...
    internal class PageStructure : PageBase
    {
        ...
        internal void Setup()
        {
            Editor.Format.SetPadrao(DataGrid);
    ...
    internal class PageBase
    {
        ...
        internal DataGridView DataGrid => Resources.DataGrid;
